                                ...
                                <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent relative">
                                    ...
                                    {isClient && (
                                        <video
                                            ...
                                            muted
                                            playsInline
                                            className="absolute bottom-full left-1/2 -translate-x-1/2 rounded-2xl shadow-xl opacity-0 duration-100 group-hover:opacity-100 transition pointer-events-none"
                                        />
                                    )}
                                </span>{" "}
                                growth this year.
